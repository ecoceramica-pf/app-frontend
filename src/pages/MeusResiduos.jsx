                ...
                <div className="p-5 pb-3 flex justify-between items-start gap-2">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <span className={`text-[10px] font-bold px-2 py-1 rounded-md uppercase ${
                      oferta.status === 'disponivel' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' :
                      oferta.status === 'em processo' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' :
                      oferta.status === 'concluido' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400' :
                      oferta.status === 'cancelado' ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' :
                      'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300'
                    }`}>
                      {oferta.status}
                    </span>
                    <span className="text-[10px] font-medium text-gray-500 bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded-md">
